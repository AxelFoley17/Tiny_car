...
#define BOARD_INITPINS_PIO0_17_GPIO GPIO                 /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITPINS_PIO0_17_GPIO_PIN_MASK (1U << 17U) /*!<@brief GPIO pin mask */
#define BOARD_INITPINS_PIO0_17_PORT 0U                   /*!<@brief PORT device index: 0 */
#define BOARD_INITPINS_PIO0_17_PIN 17U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_PIO0_17_PIN_MASK (1U << 17U)      /*!<@brief PORT pin mask */
                                                         /* @} */
...
/*! @name PIO0_16 (number 15), CN1[1]/PIO0_16
  @{ */
#define BOARD_INITCTIMER0_CAP01_CTIIMER_CAP0_PORT 0U                   /*!<@brief PORT device index: 0 */
#define BOARD_INITCTIMER0_CAP01_CTIIMER_CAP0_PIN 16U                   /*!<@brief PORT pin number */
#define BOARD_INITCTIMER0_CAP01_CTIIMER_CAP0_PIN_MASK (1U << 16U)      /*!<@brief PORT pin mask */
                                                                       /* @} */

/*! @name PIO0_1 (number 24), CN1[38]/PIO0_1/ACMP_I2/CLKIN/TDI
  @{ */
#define BOARD_INITCTIMER0_CAP01_CTIIMER_CAP1_PORT 0U                  /*!<@brief PORT device index: 0 */
#define BOARD_INITCTIMER0_CAP01_CTIIMER_CAP1_PIN 1U                   /*!<@brief PORT pin number */
#define BOARD_INITCTIMER0_CAP01_CTIIMER_CAP1_PIN_MASK (1U << 1U)      /*!<@brief PORT pin mask */
                                                                      /* @} */

/*! @name PIO0_0 (number 36), CN1[39]/PIO0_0/ACMP_I1/TDO
  @{ */
#define BOARD_INITCTIMER0_CAP01_CTIIMER_CAP2_PORT 0U                  /*!<@brief PORT device index: 0 */
#define BOARD_INITCTIMER0_CAP01_CTIIMER_CAP2_PIN 0U                   /*!<@brief PORT pin number */
#define BOARD_INITCTIMER0_CAP01_CTIIMER_CAP2_PIN_MASK (1U << 0U)      /*!<@brief PORT pin mask */
                                                                      /* @} */
 ...
 *
 */
void Board_InitCTIMER0_CAP01(void); /* Function assigned for the Cortex-M0P */

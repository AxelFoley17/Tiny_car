...
#define PIO_port_pin_ON(port, pin) GPIO_PortSet(GPIO, port, 1U << pin);
#define PIO0_17_ON() PIO_port_pin_ON(0U, 17)
//#define PIO0_17_ON() GPIO_PortSet(GPIO, 0U, 1U << 17);

#define PIO_port_pin_OFF(port, pin) GPIO_PortClear(GPIO, port, 1U << pin);
#define PIO0_17_OFF() PIO_port_pin_OFF(0U, 17)

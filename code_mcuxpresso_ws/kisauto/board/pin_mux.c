...
pin_labels:
- {pin_num: '15', pin_signal: PIO0_16, label: 'CN1[1]/PIO0_16', identifier: CTIIMER_CAP0}
- {pin_num: '24', pin_signal: PIO0_1/ACMP_I2/CLKIN, label: 'CN1[38]/PIO0_1/ACMP_I2/CLKIN/TDI', identifier: CTIIMER_CAP1}
- {pin_num: '36', pin_signal: PIO0_0/ACMP_I1, label: 'CN1[39]/PIO0_0/ACMP_I1/TDO', identifier: CTIIMER_CAP2}
- {pin_num: '47', pin_signal: PIO0_18/ADC_8, label: 'CN1[3]/PIO0_18/ADC_8'}
- {pin_num: '48', pin_signal: PIO0_17/ADC_9/DACOUT_0, label: 'CN1[2]/PIO0_17/ADC_9/DACOUT_0', identifier: UH_TRIG;PIO0_17}
...
- pin_list:
  ...
  - {pin_num: '45', peripheral: SCT0, signal: 'OUT, 2', pin_signal: PIO0_20/ADC_6}
  - {pin_num: '44', peripheral: SCT0, signal: 'OUT, 3', pin_signal: PIO0_21/ADC_5}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t PIO0_17_config = {
    ...
    /* SCT_OUT2 connect to P0_20 */
    SWM_SetMovablePinSelect(SWM0, kSWM_SCT_OUT2, kSWM_PortPin_P0_20);

    /* SCT_OUT3 connect to P0_21 */
    SWM_SetMovablePinSelect(SWM0, kSWM_SCT_OUT3, kSWM_PortPin_P0_21);
...
- options: {callFromInitBoot: 'true', coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '15', peripheral: CTIMER0, signal: 'CAPTURE, 0', pin_signal: PIO0_16}
  - {pin_num: '24', peripheral: CTIMER0, signal: 'CAPTURE, 1', pin_signal: PIO0_1/ACMP_I2/CLKIN}
  - {pin_num: '36', peripheral: CTIMER0, signal: 'CAPTURE, 2', pin_signal: PIO0_0/ACMP_I1}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : Board_InitCTIMER0_CAP01
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
/* Function assigned for the Cortex-M0P */
void Board_InitCTIMER0_CAP01(void)
{
    /* Enables clock for switch matrix.: enable */
    CLOCK_EnableClock(kCLOCK_Swm);

    /* TimerCaptureChannel0 connect to P0_16 */
    SWM_SetMovablePinSelect(SWM0, kSWM_T0_CAP_CHN0, kSWM_PortPin_P0_16);

    /* TimerCaptureChannel1 connect to P0_1 */
    SWM_SetMovablePinSelect(SWM0, kSWM_T0_CAP_CHN1, kSWM_PortPin_P0_1);

    /* TimerCaptureChannel2 connect to P0_0 */
    SWM_SetMovablePinSelect(SWM0, kSWM_T0_CAP_CHN2, kSWM_PortPin_P0_0);
